...
function Signup() {
  ...
  const CreateUser = async () => {
    try {
      ...
      // Force sign out after account creation
      await signOut(auth);
      swal({
        title: "Success!",
    ...
    signInWithPopup(auth, provider)
      .then(async (result) => {
        ...
        if (result._tokenResponse?.isNewUser) {
          // New user - sign them out and ask to sign in
          await signOut(auth);
          swal({
            title: "Account Created!",
            text: "Google account linked successfully! Please sign in to continue.",
            icon: "success",
            buttons: "Ok",
          }).then(() => {
            navigate("/");
          ...
          // Existing user trying to signup - redirect to signin
          await signOut(auth);
          swal({
            title: "Account Exists!",
            text: "This Google account already exists. Please use Sign In instead.",
            icon: "warning",
            buttons: "Ok",
          }).then(() => {
            navigate("/");
